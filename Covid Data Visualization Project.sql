...
--4.
select location,population,date, MAX(total_cases) as HighestInfectedRate, MAX((total_cases/population))*100 as PercentagePopulationInfected
from CovidDeaths
group by location, population, date
order by PercentagePopulationInfected desc;


--Original queries for data exploration
